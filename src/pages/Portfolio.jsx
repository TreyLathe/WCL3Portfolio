  ...
  return (
    <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around', margin: '2rem', }}>
      <div className="card" style={{ width: "18rem", color: "#FCDEBE",marginBottom: "2rem", backgroundColor: "rgba(52, 52, 74, 0.5)" }}>
        ...
        <a href="https://exam-builder.onrender.com" className="btn" style={{ backgroundColor: "rgba(118, 152, 179, 0.5)", color: "#FCDEBE" }}>Deployed</a>
        <a href="https://github.com/JessicaDubina/exam-builder" className="btn" style={{ backgroundColor: "rgba(118, 152, 179, 0.5)", color: "#FCDEBE" }}>GitHub Repository</a>
      </div>
      ...
      <div className="card" style={{ width: "18rem", color: "#FCDEBE", marginBottom: "2rem", backgroundColor: "rgba(52, 52, 74, 0.5)" }}>
        ...
        <a href="https://jonsantosdev.github.io/beer-is-poetic/" className="btn" style={{ backgroundColor: "rgba(118, 152, 179, 0.5)", color: "#FCDEBE"}}>Deployed</a>
        <a href="https://github.com/jonsantosdev/beer-is-poetic" className="btn" style={{ backgroundColor: "rgba(118, 152, 179, 0.5)", color: "#FCDEBE"}}>Github Repository</a>
      </div>
      ...
      <div className="card" style={{ width: "18rem",color: "#FCDEBE", marginBottom: "2rem", backgroundColor: "rgba(52, 52, 74, 0.5)" }}>
        ...
        <a href="https://moonweatherdash.netlify.app" className="btn" style={{ backgroundColor: "rgba(118, 152, 179, 0.5)", color: "#FCDEBE"}}>Deployed</a>
        <a href="https://github.com/TreyLathe/WeatherDashboard" className="btn" style={{ backgroundColor: "rgba(118, 152, 179, 0.5)", color: "#FCDEBE"}}>GitHub Repository</a>
      </div>
      ...
      <div className="card" style={{ width: "18rem",color: "#FCDEBE", marginBottom: "2rem", backgroundColor: "rgba(52, 52, 74, 0.5)"}}>
        ...
        <a href="https://coursemanagement-9c13757a824b.herokuapp.com/" className="btn" style={{ backgroundColor: "rgba(118, 152, 179, 0.5)", color: "#FCDEBE"}}>Deployed</a>
        <a href="https://github.com/TreyLathe/teams_problem_solution/" className="btn" style={{ backgroundColor: "rgba(118, 152, 179, 0.5)", color: "#FCDEBE"}}>GitHub Repository</a>
      </div>
      ...
      <div className="card" style={{ width: "18rem",color: "#FCDEBE", marginBottom: "2rem", backgroundColor: "rgba(52, 52, 74, 0.5)" }}>
        ...
        <a href="https://github.com/TreyLathe/employee-tracker-chal12" className="btn" style={{ backgroundColor: "rgba(118, 152, 179, 0.5)", color: "#FCDEBE"}}>Not Deployed</a>
        <a href="https://github.com/TreyLathe/employee-tracker-chal12" className="btn" style={{ backgroundColor: "rgba(118, 152, 179, 0.5)", color: "#FCDEBE"}}>GitHub Repository</a>
      </div>
      ...
      <div className="card" style={{ width: "18rem", color: "#FCDEBE",marginBottom: "2rem", backgroundColor: "rgba(52, 52, 74, 0.5)" }}>
        ...
        <a href="https://github.com/TreyLathe/logo-creator" className="btn" style={{ backgroundColor: "rgba(118, 152, 179, 0.5)", color: "#FCDEBE" }}>Not Deployed</a>
        <a href="https://github.com/TreyLathe/logo-creator" className="btn" style={{ backgroundColor: "rgba(118, 152, 179, 0.5)", color: "#FCDEBE" }}>Github Repository</a>
      </div>
